...
namespace Структура_предприятия_v2 {
    ...
    public partial class ManagementDataSet : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PersonRow AddPersonRow(int idPerson, string Family, string Name, string Patronymic) {
...
namespace Структура_предприятия_v2.ManagementDataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Person] WHERE (([idPerson] = @Original_idPerson) AND ([Family]" +
                " = @Original_Family) AND ([Name] = @Original_Name) AND ([Patronymic] = @Original" +
                "_Patronymic))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Person] ([idPerson], [Family], [Name], [Patronymic]) VALUES (@" +
                "idPerson, @Family, @Name, @Patronymic);\r\nSELECT idPerson, Family, Name, Patronym" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Person] SET [idPerson] = @idPerson, [Family] = @Family, [Name] = @Name, [Patronymic] = @Patronymic WHERE (([idPerson] = @Original_idPerson) AND ([Family] = @Original_Family) AND ([Name] = @Original_Name) AND ([Patronymic] = @Original_Patronymic));
SELECT idPerson, Family, Name, Patronymic FROM Person WHERE (idPerson = @idPerson)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Структура_предприятия_v2.Properties.Settings.Default.ManagementConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idPerson, Family, Name, Patronymic FROM dbo.Person";
        ...
        public virtual int Fill(ManagementDataSet.PersonDataTable dataTable) {
        ...
        public virtual ManagementDataSet.PersonDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ManagementDataSet.PersonDataTable dataTable = new ManagementDataSet.PersonDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ManagementDataSet.PersonDataTable dataTable) {
        ...
        public virtual int Delete(int Original_idPerson, string Original_Family, string Original_Name, string Original_Patronymic) {
        ...
        public virtual int Insert(int idPerson, string Family, string Name, string Patronymic) {
        ...
        public virtual int Update(int idPerson, string Family, string Name, string Patronymic, int Original_idPerson, string Original_Family, string Original_Name, string Original_Patronymic) {
            ...
            if ((Original_Family == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_Family));
            }
            if ((Original_Name == null)) {
                throw new global::System.ArgumentNullException("Original_Name");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Family, string Name, string Patronymic, int Original_idPerson, string Original_Family, string Original_Name, string Original_Patronymic) {
            return this.Update(Original_idPerson, Family, Name, Patronymic, Original_idPerson, Original_Family, Original_Name, Original_Patronymic);
        }
    }
